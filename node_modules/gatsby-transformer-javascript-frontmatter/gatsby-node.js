...
async function onCreateNode({
  ...
  const options = {
    ...
    plugins: [`jsx`, `doExpressions`, `objectRestSpread`, [`decorators`, {
      decoratorsBeforeExport: true
    }], `classProperties`, `exportExtensions`, `asyncGenerators`, `functionBind`, `functionSent`, `dynamicImport`, _.includes([`ts`, `tsx`], node.extension) ? `typescript` : `flow`]
  };
